  ...
  return <div className='flex gap-x-4 py-2 lg:px-6 border-b border-gray-200 w-full font-light text-gray-500'>
    <div className='w-full min-h-[150px] flex items-center gap-x-4'>
      ...
      <div className='w-full flex flex-col'>
        ...
        {/* remove icon */}
        <div className='text-xl cursor-pointer'><IoMdClose className='text-gray-500 hover:text-red-500 transition' /></div>
        </div>
        <div className='flex gap-x-2 h-[36px] text-sm'>
          ...
          {/* item price */}
          <div className='flex-1 flex items-center jutify-around'>$ {price}
          </div>
          {/* final price */}
